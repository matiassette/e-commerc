...
function operacion(num1, num2, str) {
    return __awaiter(this, void 0, void 0, function () {
        var promesa, Suma, Resta, resultado, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promesa = function (param) {
                ...
                case 3:
                    ...
                    switch (str) {
                        case "suma" || "Suma":
                            ...
                            return [2 /*return*/, resultado.sumar()];
                            break;
                        case "resta" || "Resta":
                            resultado = new Resta(num1, num2);
                            return [2 /*return*/, resultado.restar()];
                            break;
                    }
                    return [3 /*break*/, 5];
                case 4:
...
function operaciones() {
    return __awaiter(this, void 0, void 0, function () {
        var unaSuma, unaResta;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, operacion(5, 3, "suma")];
                case 1:
                    unaSuma = _a.sent();
                    console.log(unaSuma);
